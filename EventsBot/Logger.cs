...
namespace Events.Bot
{
    ...
    public class Logger
    {
        ...
        ///     Writes a trace log.
        /// </summary>
        /// <param name="content">The content of the trace log.</param>
        /// <param name="severity">The severity of the trace log, normally a source.</param>
        /// <param name="exception">
        ///     The optional exception of the trace log, if this parameter isnt <see langword="null"/> 
        ///     then the log will be written to the standard error stream.</param>
        /// <param name="stdErr"><see langword="true"/> if this log should be written to the standard error stream; otherwise <see langword="false"/></param>
        ...
        /// <param name="severity">The severity of the log, normally a source.</param>
        /// <param name="exception">
        ///     The optional exception of the log, if this parameter isnt <see langword="null"/> 
        ///     then the log will be written to the standard error stream.</param>
        /// <param name="stdErr"><see langword="true"/> if this log should be written to the standard error stream; otherwise <see langword="false"/></param>
        ...
        /// </summary>
        /// <param name="content">The content of the warning log.</param>
        /// <param name="severity">The severity of the warning log, normally a source.</param>
        /// <param name="exception">
        ///     The optional exception of the warning log, if this parameter isnt <see langword="null"/> 
        ///     then the log will be written to the standard error stream.</param>
        /// <param name="stdErr"><see langword="true"/> if this log should be written to the standard error stream; otherwise <see langword="false"/></param>
        ...
        ///     Writes a error log.
        /// </summary>
        /// <param name="content">The content of the error log.</param>
        /// <param name="severity">The severity of the error log, normally a source.</param>
        /// <param name="exception">
        ///     The optional exception of the error log, if this parameter isnt <see langword="null"/> 
        ///     then the log will be written to the standard error stream.</param>
        /// <param name="stdErr"><see langword="true"/> if this log should be written to the standard error stream; otherwise <see langword="false"/></param>
        ...
        /// </summary>
        /// <param name="content">The content of the critical log.</param>
        /// <param name="severity">The severity of the critical log, normally a source.</param>
        /// <param name="exception">
        ///     The optional exception of the critical log, if this parameter isnt <see langword="null"/> 
        ///     then the log will be written to the standard error stream.</param>
        /// <param name="stdErr"><see langword="true"/> if this log should be written to the standard error stream; otherwise <see langword="false"/></param>
        ...
        ///     Writes a debug log.
        /// </summary>
        /// <param name="content">The content of the debug log.</param>
        /// <param name="severity">The severity of the debug log, normally a source.</param>
        /// <param name="exception">
        ///     The optional exception of the debug log, if this parameter isnt <see langword="null"/> 
        ///     then the log will be written to the standard error stream.</param>
        /// <param name="stdErr"><see langword="true"/> if this log should be written to the standard error stream; otherwise <see langword="false"/></param>
        ...
        ///     Writes a info log.
        /// </summary>
        /// <param name="content">The content of the info log.</param>
        /// <param name="severity">The severity of the info log, normally a source.</param>
        /// <param name="exception">
        ///     The optional exception of the info log, if this parameter isnt <see langword="null"/> 
        ///     then the log will be written to the standard error stream.</param>
        /// <param name="stdErr"><see langword="true"/> if this log should be written to the standard error stream; otherwise <see langword="false"/></param>
        ...
        /// </summary>
        /// <param name="content">The content of the generic log.</param>
        /// <param name="severity">The severities of the generic log.</param>
        /// <param name="exception">
        ///     The optional exception of the generic log, if this parameter isnt <see langword="null"/> 
        ///     then the log will be written to the standard error stream.</param>
        /// <param name="stdErr"><see langword="true"/> if this log should be written to the standard error stream; otherwise <see langword="false"/></param>
        ...
        /// <summary>
        ///     Gets an instance of a logger for the given type.
        /// </summary>
        /// <typeparam name="TType">The type to get the logger for.</typeparam>
        ...
        ///     Gets an instance of a logger for the given type.
        /// </summary>
        /// <param name="t">The type to get the logger for.</param>
        /// <returns>The newly created logger.</returns>
        ...
        /// <summary>
        ///     Adds a stream source to the logger
        /// </summary>
        /// <param name="stream">The stream to write to.</param>
        /// <param name="type">The type of log for this stream.</param>
