...
namespace Events.Bot
{
    internal static class ReflectionUtils
    {
        ...
        internal static T CreateObject<T>(TypeInfo typeInfo, IServiceProvider services = null)
            => CreateBuilder<T>(typeInfo)(services);
        internal static Func<IServiceProvider, T> CreateBuilder<T>(TypeInfo typeInfo)
        {
        ...
        private static object GetMember(IServiceProvider services, Type memberType, TypeInfo ownerType)
        {
